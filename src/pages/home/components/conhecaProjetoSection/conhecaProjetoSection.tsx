...
import "./style.css"
import mapaBarcarena from "@assets/images/home/barcarena_setores.svg";
  ...
  return (
    <section className="conheca-section">
      ...
      <div className="conheca-inner">
        ...
        <div className="barca-textcol">
          <h2 className="conheca-eyebrow">Conheça Barcarena</h2>
          <div className="barca-para"><span className="barca-ic"><svg viewBox="0 0 24 24" fill="none"><path d="M12 2C8.1 2 5 5.1 5 9c0 5.2 7 13 7 13s7-7.8 7-13c0-3.9-3.1-7-7-7z" stroke="#8DC63F" stroke-width="1.8"></path><circle cx="12" cy="9" r="2.6" stroke="#8DC63F" stroke-width="1.8"></circle></svg></span><p>Barcarena é um município paraense localizado às margens da <strong>Baía do Marajó</strong>, na Região Metropolitana de Belém, a cerca de <strong>40 km</strong> da capital. Com aproximadamente <strong>127 mil habitantes</strong> e mais de <strong>1.300 km²</strong>, reúne áreas urbanas, industriais, ribeirinhas e insulares.</p></div>
          <div className="barca-para"><span className="barca-ic"><svg viewBox="0 0 24 24" fill="none" stroke="#8DC63F" stroke-width="1.7" stroke-linejoin="round"><path d="M3 21h18V9l-6 4V9l-6 4V4H6v9z"></path><rect x="17" y="3" width="2.4" height="4"></rect></svg></span><p>O município é um dos principais polos industriais e portuários da Amazônia, abrigando o <strong>Porto de Vila do Conde</strong>, o maior do Pará, e um importante complexo produtivo de alumina, alumínio primário, caulim e fertilizantes. Sua economia também conta com forte presença da agricultura familiar e com o crescimento do turismo, impulsionado pelas praias de água doce, ilhas e paisagens amazônicas.</p></div>
