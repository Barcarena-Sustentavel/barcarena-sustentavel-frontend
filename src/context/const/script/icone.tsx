const carregarIconePorDimensao = (iconName: string) => {
...
export const carregarTodosOsIcones = () => {
  const [
    logoEmprego,
    logoMeioAmbiente,
    logoEducacao,
    ...
    carregarIconePorDimensao('emprego'),
    carregarIconePorDimensao('meioAmbiente'),
    carregarIconePorDimensao('educacao'),
    carregarIconePorDimensao('mobilidade'),
    carregarIconePorDimensao('ordenamento'),
    carregarIconePorDimensao('seguranca'),
    carregarIconePorDimensao('saude'),
    carregarIconePorDimensao('conectividade'),
    carregarIconePorDimensao('instituicoes'),
  ]);
