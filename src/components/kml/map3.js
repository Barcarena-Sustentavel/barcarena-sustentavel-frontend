...
const Map3 = () => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { style: { height: '100%', width: '100%' }, children: [(0, jsx_runtime_1.jsxs)(MapContainer_1.MapContainer, { style: { height: '50%', width: '100%' }, center: [-1.51130, -48.61914], zoom: 10, scrollWheelZoom: true, children: [(0, jsx_runtime_1.jsx)(TileLayer_1.TileLayer, { attribution: '\u00A9 <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors', url: "https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" }), kmlDocument && (0, jsx_runtime_1.jsx)(react_leaflet_kml_1.default, { kml: kmlDocument }), diagram.length > 0 && diagram.map((position, idx) => (0, jsx_runtime_1.jsxs)(Marker_1.Marker, { position: position, children: [(0, jsx_runtime_1.jsx)(Popup_1.Popup, { children: (0, jsx_runtime_1.jsx)("span", { children: "User" }) }), (0, jsx_runtime_1.jsx)(react_leaflet_1.Tooltip, { children: "Tooltip for Marker" })] }, `marker-${idx}`))] }), (0, jsx_runtime_1.jsx)(react_bootstrap_1.Container, { children: (0, jsx_runtime_1.jsxs)(react_bootstrap_1.Row, { children: [(0, jsx_runtime_1.jsx)(react_bootstrap_1.Col, { md: 6, children: (0, jsx_runtime_1.jsxs)(react_bootstrap_2.Form.Select, { "aria-label": "Default select example", children: [(0, jsx_runtime_1.jsx)("option", { selected: true, children: "Escolha a dimens\u00E3o" }), " :", const_1.default.map((dimensao) => ((0, jsx_runtime_1.jsx)("option", { onClick: getKml(dimensao), children: dimensao }, dimensao)))] }) }), (0, jsx_runtime_1.jsx)(react_bootstrap_1.Col, { md: 6, children: (0, jsx_runtime_1.jsxs)(react_bootstrap_2.Form.Select, { disabled: formIndicadoresAble, id: "formIndicadores", "aria-label": "Default select example", children: [(0, jsx_runtime_1.jsx)("option", { selected: true, children: "Escolha o seu indicador" }), " :", kmls.length > 0 && kmls.map((kml) => ((0, jsx_runtime_1.jsx)("option", { onClick: getKmlCoords(kml.nome), children: kml.nome }, kml.nome)))] }) })] }) })] }));
};
