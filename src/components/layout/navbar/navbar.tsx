    ...
    <Navbar expand="lg" className="flex-row navbar-light bg-light">
      ...
      >
        ...
        <Navbar.Collapse id="navbarNav">
          <Nav
            className="navbar-nav d-none d-lg-flex justify-content-end"
            style={{
              width: "100%",
              justifyContent: "space-between",
              display: "flex",
            ...
            <Modal.Body>
              <Nav className="navbar-nav">
                ...
                <MobileModalItem
                  ...
                  to={"/about"}
                  style={
                    { "--clr": "var(--secondary-green)" } as React.CSSProperties
                  }
                >
